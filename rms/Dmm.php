...
<head>
    ...
    <title>Deliver Management </title>
                  ...
                  <nav id="site-navigation" class="main-navigation"  aria-label="Primary Navigation">
                     ...
                     <div class="handheld-navigation">
                        ...
                        <ul  class="menu">
                           ...
                           <li class="menu-item "><a href="piz.php"><i class="po po-burger"></i>Burgers</a></li>
                           <li class="menu-item "><a href="piz.php"><i class="po po-drinks"></i>Beverage</a></li>
                        </ul>
                     </div>
                  </nav>
                  <!-- #site-navigation -->
...
<div id="content" class="site-content" tabindex="-1" >
                        ...
                        <div class="entry-content">
                           <div class="woocommerce">
                              <div class="customer-login-form">
                                 ...
                                 <div class="u-columns col2-set" id="customer_login">
                                    ...
                                    <!-- <div class="u-column1 col-1">
                                       ...
                                       <form action=test/index.php>
                                        ...
                                        <form action=test/deliver.php>
                                        <input type="submit" value="Delivery">
                                        </form>
                                       


                                        <form action=test/create.php>
                                 ...
                                 <table>
  <tr>
    <th><form action=test/index.php>
                                        >
    <th><form action=#>
                                        <input type="submit" value="eksith">
                                        </form></th>
    <th><form action=#>
  ...
  <tr>
  <th><form action=test/deliver.php>
                                        
    <th><form action=#>
                                        <input type="submit" value="Madushanka">
                                        </form></th>
    <th><form action=#>
  ...
  <tr>
  <th><form action=test/create.php>
                                       
    <th><form action=#>
                                        <input type="submit" value="kule">
                                        </form></th>
    <th><form action=#>
  ...
  <tr>
  <th><form action=test/deltab.php>
                                        <
    <th><form action=#>
                                        <input type="submit" value="Dhayan">
                                        </form></th>
    <th><form action=#>
