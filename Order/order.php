...
<?php 
	...
	if (isset($_GET['search'])) {
		...
		$search = mysqli_real_escape_string($connection, $_GET['search']);
			...
			$query = "SELECT * FROM orderdb.order WHERE is_deleted=0 ORDER BY id";
	...
	//if ($orders) 
	{
		...
		while ($order = mysqli_fetch_assoc($orders)) {
			...
			$order_list .="<tr>";
				...
				$order_list .="<td><a href=\"modify-order.php?order_id={$order['id']}\">Edit</a></td>";
				$order_list .="<td><a href=\"delete-order.php?order_id={$order['id']}\">delete</a></td>";
